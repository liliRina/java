...
public class LeasingContract {
    ...
    private CopyOnWriteArrayList<Payment> paymentSchedule;
    ...
    public LeasingContract(
        ...
        this.paymentSchedule = new CopyOnWriteArrayList<>();
    ...
    public void repay() {
        ...
        indCurPayment--;
        paymentSchedule.get(indCurPayment).setStatus(Payment.Status.NOT_PAID);
    }
