...
public class ClientBase {
    ...
    private ClientBaseIO clientsIO;

    public ClientBase() {
        clientsIO = new ClientBaseIO();
        clientsIO.readClients(clients);
    }
